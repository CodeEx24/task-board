...
export default function TaskColumn({
  ...
  return (
    <section
      className={`flex flex-col min-h-[200px] md:min-h-[400px] w-full md:w-80 md:flex-shrink-0 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 overflow-hidden transition-all duration-200 ${
